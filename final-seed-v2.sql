-- Cascading truncate to remove everything
TRUNCATE TABLE fee_installments, fee_heads, enquiries, attendance_records, exam_marks, exam_subjects, exam_terms, staff, students, class_sections, users, branches, roles RESTART IDENTITY CASCADE;
